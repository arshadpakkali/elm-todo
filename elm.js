...
{
	if (region.bP.ad === region.cd.ad)
	{
		return 'on line ' + region.bP.ad;
	}
	return 'on lines ' + region.bP.ad + ' through ' + region.cd.ad;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dQ: 'hidden', dx: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dQ: 'mozHidden', dx: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dQ: 'msHidden', dx: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dQ: 'webkitHidden', dx: 'webkitvisibilitychange' }
		: { dQ: 'hidden', dx: 'visibilitychange' };
}
...
var $author$project$Main$Model = F2(
	function (todos, todoInput) {
		return {ai: todoInput, X: todos};
	});
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cg: fragment, cm: host, cB: path, cD: port_, cG: protocol, cH: query};
	});
...
var $elm$browser$Browser$sandbox = function (impl) {
	return _Browser_element(
		{
			dX: function (_v0) {
				return _Utils_Tuple2(impl.dX, $elm$core$Platform$Cmd$none);
			},
			eG: function (_v1) {
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {c4: 'a', b4: 'atv', c6: 'ab', c7: 'cx', c8: 'cy', c9: 'acb', da: 'accx', db: 'accy', dc: 'acr', b6: 'al', b7: 'ar', dd: 'at', a1: 'ah', a2: 'av', dg: 's', dk: 'bh', dl: 'b', dn: 'w7', dp: 'bd', dq: 'bdt', aq: 'bn', dr: 'bs', at: 'cpe', dy: 'cp', dz: 'cpx', dA: 'cpy', A: 'c', aw: 'ctr', ax: 'cb', ay: 'ccx', B: 'ccy', aa: 'cl', az: 'cr', dC: 'ct', dD: 'cptr', dE: 'ctxt', dN: 'fcs', cf: 'focus-within', dO: 'fs', dP: 'g', bj: 'hbh', bk: 'hc', ck: 'he', bl: 'hf', cl: 'hfp', dR: 'hv', dU: 'ic', dW: 'fr', aH: 'lbl', dY: 'iml', dZ: 'imlf', d_: 'imlp', d$: 'implw', d0: 'it', d1: 'i', cr: 'lnk', V: 'nb', ct: 'notxt', ea: 'ol', ec: 'or', N: 'oq', ef: 'oh', cz: 'pg', cA: 'p', eg: 'ppe', em: 'ui', s: 'r', en: 'sb', eo: 'sbx', ep: 'sby', eq: 'sbt', ev: 'e', ew: 'cap', ex: 'sev', eE: 'sk', eI: 't', eJ: 'tc', eK: 'w8', eL: 'w2', eM: 'w9', eN: 'tj', aW: 'tja', eO: 'tl', eP: 'w3', eQ: 'w5', eR: 'w4', eS: 'tr', eT: 'w6', eU: 'w1', eV: 'tun', cW: 'ts', Q: 'clr', e0: 'u', b_: 'wc', c$: 'we', b$: 'wf', c0: 'wfp', b2: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.A);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dP);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cz);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cA);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.s);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ev);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.bL)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.v)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ey.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ey.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.s) + ('-' + ($elm$core$String$fromInt(pos.dB) + ('-' + ($elm$core$String$fromInt(pos.c_) + ('-' + $elm$core$String$fromInt(pos.cj)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.cu.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.cu.b) + 'px'),
					$elm$core$Maybe$Just(
								...
								$mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
									{
										...
										cu: A2(
											...
											A2($elm$core$Tuple$mapFirst, $elm$core$Basics$toFloat, shadow.cu)),
										n: shadow.n
									}));
						},
						focus.eu),
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dR, $mdgriffith$elm_ui$Internal$Style$classes.Q)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dR, $mdgriffith$elm_ui$Internal$Style$classes.N)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dN, $mdgriffith$elm_ui$Internal$Style$classes.N)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.b4, $mdgriffith$elm_ui$Internal$Style$classes.Q)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.b4, $mdgriffith$elm_ui$Internal$Style$classes.N)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dg) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dg) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dg) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.s) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dg) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aw) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {av: closing, g: _List_Nil, E: _List_Nil, t: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								g: A2(
									$elm$core$List$cons,
									{av: '\n}', g: _List_Nil, E: props, t: '@supports (' + (prop + (':' + (value + (') {' + parent.t))))},
									rendered.g)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.t + ('{' + (renderValues(rule.E) + (rule.av + '}')));
		}
	};
		...
		switch (rule.$) {
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							...
							'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.c_) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.s) + (' / ' + ($elm$core$String$fromInt(position.s + position.cj) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.dB) + (' / ' + ($elm$core$String$fromInt(position.dB + position.c_) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.s) + ('-' + ($elm$core$String$fromInt(position.dB) + ('-' + ($elm$core$String$fromInt(position.c_) + ('-' + $elm$core$String$fromInt(position.cj)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.eI + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.eI)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.ew + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.eI + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.ew + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.eI)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {cj: height / size, n: size, e2: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.dw, adjustment.dj, adjustment.dG, adjustment.d3]);
	var lineHeight = 1.5;
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'vertical-align',
				$elm$core$String$fromFloat(converted.e2) + 'em'),
				_Utils_Tuple2(
				'font-size',
				$elm$core$String$fromFloat(converted.n) + 'em')
			]));
};
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ev))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dg, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.B, $mdgriffith$elm_ui$Internal$Style$classes.dc])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dg, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.B, $mdgriffith$elm_ui$Internal$Style$classes.da])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dg, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.db])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dg, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.aw, $mdgriffith$elm_ui$Internal$Style$classes.c9])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eI + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.b_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bk)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.dg + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eI + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bl)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.eF : _Utils_ap(styled.eF, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.dS, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.eF : _Utils_ap(styled.eF, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.eF : _Utils_ap(rendered.eF, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.c4]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.dl]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.ec]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.ea]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.dW]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.V, $mdgriffith$elm_ui$Internal$Style$classes.ev, $mdgriffith$elm_ui$Internal$Style$classes.dk]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b6);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b7);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a1 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c7);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.a2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dd);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.a2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c6);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.a2 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c8);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.dg + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.A + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.c$ + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.c0 + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.c$ + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.c0 + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.eF);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.dC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aa)),
				A2(
					$elm$core$List$cons,
...
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('Simple Todo List')
				]))
		]));
var $author$project$Main$AddTodo = {$: 0};
var $author$project$Main$InputChange = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$color = {
	b9: A3($mdgriffith$elm_ui$Element$rgb255, 114, 159, 207),
	dF: A3($mdgriffith$elm_ui$Element$rgb255, 46, 52, 54),
	bp: A3($mdgriffith$elm_ui$Element$rgb255, 197, 232, 247),
	cq: A3($mdgriffith$elm_ui$Element$rgb255, 224, 224, 224),
	e4: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)
};
var $aforemny$material_components_web_elm$Material$Button$Internal$Config = $elm$core$Basics$identity;
var $aforemny$material_components_web_elm$Material$Button$config = {a_: _List_Nil, ba: false, ab: false, ac: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, bS: $elm$core$Maybe$Nothing, ak: true, aX: false};
	...
	return A2(
		...
		function () {
			...
			if (!_v1.$) {
				if (!_v1.a.$) {
					var node = _v1.a.a.aM;
					var attributes = _v1.a.a.ao;
					var nodes = _v1.a.a.aN;
					return $elm$core$Maybe$Just(
						A2(
							node,
							A2(
...
var $aforemny$material_components_web_elm$Material$List$config = {a_: _List_Nil, a4: false, ba: false, aI: true, aS: true, bV: false, e2: false, b1: false};
...
var $aforemny$material_components_web_elm$Material$List$list = F3(
	function (config_, firstListItem, remainingListItems) {
		var ripples = config_.aS;
		var interactive = config_.aI;
		var additionalAttributes = config_.a_;
...
var $aforemny$material_components_web_elm$Material$Button$button = F3(
	function (variant, config_, label) {
		...
		var additionalAttributes = innerConfig.a_;
		var touch = innerConfig.ak;
		var href = innerConfig.ac;
		var disabled = innerConfig.ab;
...
var $aforemny$material_components_web_elm$Material$Button$setOnClick = F2(
	function (onClick, _v0) {
		...
		return _Utils_update(
			config_,
			{
				bx: $elm$core$Maybe$Just(onClick)
			});
	});
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {ds: -box.ds, d2: -box.d2, el: -box.el, eZ: -box.eZ};
};
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{j: _List_Nil, b: _List_Nil, f: _List_Nil, a: _List_Nil, Z: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ct + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eg)),
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			_Utils_eq(textInput.bW, $mdgriffith$elm_ui$Element$Input$TextArea),
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.eI),
							$mdgriffith$elm_ui$Internal$Model$Attr(
									...
									function () {
										if (textOptions.eI === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.eI === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.eI + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.j, textOptions.eI === ''))
												]);
										}
									}()
									])))),
...
var $mdgriffith$elm_ui$Element$Input$text = $mdgriffith$elm_ui$Element$Input$textHelper(
	{
		...
		u: false,
		bW: $mdgriffith$elm_ui$Element$Input$TextInputNode('text')
	});
var $author$project$Main$todoInput = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$color.bp)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$kmbn$elm_hotkeys$Hotkeys$onEnter($author$project$Main$AddTodo))
					]),
				{
					co: $mdgriffith$elm_ui$Element$Input$labelHidden('hidden'),
					d8: $author$project$Main$InputChange,
					eh: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('Task name'))),
					eI: model.ai
				}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				...
				$mdgriffith$elm_ui$Element$html(
					A2(
						...
						A2($aforemny$material_components_web_elm$Material$Button$setOnClick, $author$project$Main$AddTodo, $aforemny$material_components_web_elm$Material$Button$config),
						' + ')))
			]));
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ay + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.B + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eq + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ct)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Main$buttonAttrs = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$padding(5),
		$mdgriffith$elm_ui$Element$Border$width(1),
		$mdgriffith$elm_ui$Element$Border$color($author$project$Main$color.b9),
		$mdgriffith$elm_ui$Element$Background$color($author$project$Main$color.bp)
	]);
var $author$project$Main$todos = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$color.cq),
				$mdgriffith$elm_ui$Element$Border$width(1)
			]),
		A2(
			$elm$core$List$map,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							{
								co: $mdgriffith$elm_ui$Element$text(' - '),
								eb: $elm$core$Maybe$Just(
									$author$project$Main$DeleteTodo(x))
							})
						]));
			},
			model.X));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$todoInput(model),
				$author$project$Main$todos(model)
			]));
};
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{dN: $elm$core$Maybe$Nothing, dR: $elm$core$Maybe$Nothing, d5: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.em, $mdgriffith$elm_ui$Internal$Style$classes.dg, $mdgriffith$elm_ui$Internal$Style$classes.ev]))),
...
var $author$project$Main$view = function (model) {
	return $author$project$Main$elementView(model);
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{dX: $author$project$Main$init, e1: $author$project$Main$update, e3: $author$project$Main$view});
